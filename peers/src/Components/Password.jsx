        ...
        <div className="bg-purple-900 h-full flex border-2 rounded-t-3xl w-full gap-4">
          <div className="flex flex-col gap-10 mt-4 w-full p-2">
            <div className="flex w-full flex-col justify-evenly gap-10 mt-4 p-1">
              ...
              <label htmlFor="firstname" className="ml-2 text-white text-2xl font-bold">Enter New Password</label>
              <div className="">
                <input
              ...
              <div className="flex flex-col gap-6">
              <label htmlFor="firstname" className="ml-2 text-white font-bold text-2xl">Confirm Password</label>
              <div className="">
                <input
